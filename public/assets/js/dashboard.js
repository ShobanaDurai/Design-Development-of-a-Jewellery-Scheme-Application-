  ...
  $(function () {
    ...
    var circle = new ProgressBar.Circle('#circle-progress-1', {
      ...
      text: {
        ...
        value: '<p class="circle-progress-value"></p><p class="circle-progress-label">Gold Transaction</p>'
      }
    });
    ...
    var circle2 = new ProgressBar.Circle('#circle-progress-2', {
      ...
      text: {
        autoStyleContainer: false,
        value: '<p class="circle-progress-value"></p><p class="circle-progress-label">Wealth Transaction</p>'
      }
    });
    ...
    // }
        ...
        $(document).ready(function() {
            if ($("#performance-indicator-chart").length) {
                const ctx = document.getElementById('performance-indicator-chart').getContext('2d');
                ...
                $.ajax({
                    url: '/api/chart-data', // Update with your route
                    method: 'GET',
                    success: function(response) {
                        myChart.data.datasets[0].data = response.all_users;
                        myChart.data.datasets[1].data = response.gold_users;
                        myChart.data.datasets[2].data = response.other_users;
                        myChart.update();
                    },
