                            ...
                            <div class="container p-0">
                                <div class="row layout-top-spacing">
                                    <div class="col-lg-12 layout-spacing">
                                        <form action="{{ route('admin.wealth-treasure-scheme.store') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @if(isset($scheme))
                                                ...
                                                <div class="widget-content widget-content-area">
                                                    <div class="widget-content widget-content-area">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-8 col-md-9 col-sm-12">
                                                                <div class="form-group" style="border: solid 1px #333;">
                                                                    <input type="text" class="form-control  @error('title') is-invalid @enderror" id="title" name="title" placeholder="Title"  value="{{ $schemewealth->title }}" required>
                                                                    @error('title')
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-8 col-md-9 col-sm-12">
                                                                <div class="form-group " style="border: solid 1px #333;">
                                                                    <textarea class="form-control @error('short_description') is-invalid @enderror"  rows="3" id="short_description" name="short_description" required>{{ $schemewealth->short_description }}</textarea>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-8 col-md-9 col-sm-12">
                                                                <div class="form-group" style="border: solid 1px #333;">
                                                                    <input type="file" class="form-control @error('image') is-invalid @enderror" accept="image/*" id="image" name="image" value="{{ $schemewealth->image }}">
                                                                    @error('image')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
                                                                        </span>
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                            <div class=" form-group">
                                                                <textarea id="summernote-editor"  name="description" class=" form-control @error('description') is-invalid @enderror">{{ $schemewealth->description }}</textarea>
