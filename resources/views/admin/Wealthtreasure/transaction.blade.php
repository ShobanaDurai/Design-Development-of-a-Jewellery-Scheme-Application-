...
@section('content')
    <div class="content">
        <h2 style="font-size: 1.5rem; color: #333; margin-bottom: 10px;margin-top: 1px; font-weight: bold;">
             Wealth Treasure Transaction Details
        </h2>
        <div class="wealth-transaction-container">
            <!-- Search Bar -->
            <div class="d-flex justify-content-between mb-3">
                <h3 class="me-3"> Customer Transaction Details</h3>
                <form action="{{ route('admin_wealth_transaction', ['id' => request()->route('id')]) }}" method="GET" class="d-flex" id="searchForm">
